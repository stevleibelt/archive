...
/**
 * Base class that represents a query for the 'media_library_user_identities' table.
 *
 *
 *
...
abstract class BaseIdentityQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, login, password, user_id FROM media_library_user_identities WHERE id = :p0';
        try {
