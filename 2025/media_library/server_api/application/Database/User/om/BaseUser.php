...
/**
 * Base class that represents a row from the 'media_library_user_users' table.
 *
 *
 *
...
abstract class BaseUser extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Database\\User\\UserPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO media_library_user_users (%s) VALUES (%s)',
    ...
    public function setIdentitys(PropelCollection $identitys, PropelPDO $con = null)
    {
        ...
        $this->identitysScheduledForDeletion = $identitysToDelete;
    ...
    public function addIdentity(Identity $l)
    {
        ...
        if (!in_array($l, $this->collIdentitys->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            ...
            if ($this->identitysScheduledForDeletion and $this->identitysScheduledForDeletion->contains($l)) {
                $this->identitysScheduledForDeletion->remove($this->identitysScheduledForDeletion->search($l));
            }
        }
