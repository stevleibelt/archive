...
/**
 * Base class that represents a query for the 'media_library_user_users' table.
 *
 *
 *
...
abstract class BaseUserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, firstName, lastName, email, is_active FROM media_library_user_users WHERE id = :p0';
        try {
