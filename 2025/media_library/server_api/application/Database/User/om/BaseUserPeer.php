...
/**
 * Base static class for performing query and update operations on the 'media_library_user_users' table.
 *
 *
 *
...
abstract class BaseUserPeer
{
    ...
    const TABLE_NAME = 'media_library_user_users';
    ...
    const ID = 'media_library_user_users.id';

    /** the column name for the firstName field */
    const FIRSTNAME = 'media_library_user_users.firstName';

    /** the column name for the lastName field */
    const LASTNAME = 'media_library_user_users.lastName';

    /** the column name for the email field */
    const EMAIL = 'media_library_user_users.email';

    /** the column name for the is_active field */
    const IS_ACTIVE = 'media_library_user_users.is_active';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to media_library_user_users
    ...
    /**
     * Deletes all rows from the media_library_user_users table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
