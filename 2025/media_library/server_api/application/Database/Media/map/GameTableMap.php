...
/**
 * This class defines the structure of the 'media_library_media_game' table.
 *
 *
...
class GameTableMap extends TableMap
{
    ...
    {
        // attributes
        $this->setName('media_library_media_game');
        ...
        $this->addForeignKey('platform_id', 'PlatformId', 'CHAR', 'media_library_media_platform', 'id', true, 36, null);
        // validators
    } // initialize()
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Platform', 'Database\\Media\\Platform', RelationMap::MANY_TO_ONE, array('platform_id' => 'id', ), null, null);
    } // buildRelations()
