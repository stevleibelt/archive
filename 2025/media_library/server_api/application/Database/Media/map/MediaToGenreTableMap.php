...
/**
 * This class defines the structure of the 'media_library_media_to_genre' table.
 *
 *
...
class MediaToGenreTableMap extends TableMap
{
    ...
    {
        // attributes
        $this->setName('media_library_media_to_genre');
        ...
        $this->addForeignKey('media_genre_id', 'MediaGenreId', 'CHAR', 'media_library_media_genre', 'id', true, 36, null);
        // validators
    } // initialize()
