...
/**
 * This class defines the structure of the 'media_library_media_audio' table.
 *
 *
...
class AudioTableMap extends TableMap
{
    ...
    {
        // attributes
        $this->setName('media_library_media_audio');
        $this->setPhpName('Audio');
        $this->setClassname('Database\\Media\\Audio');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Track', 'Database\\Media\\Audio\\Track', RelationMap::ONE_TO_MANY, array('id' => 'audio_id', ), null, null, 'Tracks');
    } // buildRelations()
