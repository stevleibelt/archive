...
use Database\Media\map\VideoTableMap;

/**
 * Base static class for performing query and update operations on the 'media_library_media_video' table.
 *
 *
 *
...
abstract class BaseVideoPeer
{
    ...
    const TABLE_NAME = 'media_library_media_video';

    /** the related Propel class for this table */
    const OM_CLASS = 'Database\\Media\\Video';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\Media\\map\\VideoTableMap';
    ...
    const ID = 'media_library_media_video.id';

    /** the column name for the media_id field */
    const MEDIA_ID = 'media_library_media_video.media_id';

    /** the column name for the duration field */
    const DURATION = 'media_library_media_video.duration';

    /** the column name for the number_of_discs field */
    const NUMBER_OF_DISCS = 'media_library_media_video.number_of_discs';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Video objects.
     ...
     * e.g. VideoPeer::$fieldNames[VideoPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'MediaId', 'Duration', 'NumberOfDiscs', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'mediaId', 'duration', 'numberOfDiscs', ),
        BasePeer::TYPE_COLNAME => array (VideoPeer::ID, VideoPeer::MEDIA_ID, VideoPeer::DURATION, VideoPeer::NUMBER_OF_DISCS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'MEDIA_ID', 'DURATION', 'NUMBER_OF_DISCS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'media_id', 'duration', 'number_of_discs', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. VideoPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MediaId' => 1, 'Duration' => 2, 'NumberOfDiscs' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'mediaId' => 1, 'duration' => 2, 'numberOfDiscs' => 3, ),
        BasePeer::TYPE_COLNAME => array (VideoPeer::ID => 0, VideoPeer::MEDIA_ID => 1, VideoPeer::DURATION => 2, VideoPeer::NUMBER_OF_DISCS => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'MEDIA_ID' => 1, 'DURATION' => 2, 'NUMBER_OF_DISCS' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'media_id' => 1, 'duration' => 2, 'number_of_discs' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        $toNames = VideoPeer::getFieldNames($toType);
        $key = isset(VideoPeer::$fieldKeys[$fromType][$name]) ? VideoPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(VideoPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, VideoPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return VideoPeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(VideoPeer::MEDIA_ID);
            $criteria->addSelectColumn(VideoPeer::DURATION);
            $criteria->addSelectColumn(VideoPeer::NUMBER_OF_DISCS);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(VideoPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(VideoPeer::DATABASE_NAME);
     ...
     *
     * @param Video $obj A Video object.
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(VideoPeer::$instances[$key])) {
                return VideoPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (VideoPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        VideoPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to media_library_media_video
    ...
    public static function doCountJoinMedia(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(VideoPeer::MEDIA_ID, MediaPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Video objects pre-filled with their Media objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinMedia(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Video) to $obj2 (Media)
                $obj2->addVideo($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Video) to the collection in $obj2 (Media)
                $obj2->addVideo($obj1);
    ...
    {
        return Propel::getDatabaseMap(VideoPeer::DATABASE_NAME)->getTable(VideoPeer::TABLE_NAME);
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseVideoPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\Media\map\VideoTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(VideoPeer::DATABASE_NAME);
    ...
    /**
     * Deletes all rows from the media_library_media_video table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
