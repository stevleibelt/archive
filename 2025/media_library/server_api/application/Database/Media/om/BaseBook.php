...
/**
 * Base class that represents a row from the 'media_library_media_book' table.
 *
 *
 *
...
abstract class BaseBook extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Database\\Media\\BookPeer';
    ...
    /**
     * The value for the number_of_pages field.
     * @var        int
     */
    protected $number_of_pages;

    /**
     * The value for the isbn_10 field.
    ...
    /**
     * The value for the isbn_13 field.
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $isbn_13;
    ...
    /**
     * Get the [number_of_pages] column value.
     *
     * @return int
     */
    ...
    public function setMediaId($v)
    {
        ...
        if ($this->media_id !== $v) {
            $this->media_id = $v;
            $this->modifiedColumns[] = BookPeer::MEDIA_ID;
        }
    ...
    /**
     * Set the value of [number_of_pages] column.
     *
     * @param  int $v new value
     * @return Book The current object (for fluent API support)
     */
    public function setNumberOfPages($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->number_of_pages !== $v) {
            $this->number_of_pages = $v;
            $this->modifiedColumns[] = BookPeer::NUMBER_OF_PAGES;
        }
    ...
    /**
     * Set the value of [isbn_10] column.
     *
     * @param  string $v new value
     * @return Book The current object (for fluent API support)
     */
    public function setIsbn10($v)
    {
        ...
        if ($this->isbn_10 !== $v) {
            $this->isbn_10 = $v;
            $this->modifiedColumns[] = BookPeer::ISBN_10;
        }
    ...
    /**
     * Set the value of [isbn_13] column.
     *
     * @param  string $v new value
     * @return Book The current object (for fluent API support)
     */
    public function setIsbn13($v)
    {
        ...
        if ($this->isbn_13 !== $v) {
            $this->isbn_13 = $v;
            $this->modifiedColumns[] = BookPeer::ISBN_13;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->number_of_pages = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->isbn_10 = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->isbn_13 = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BookPeer::MEDIA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'media_id';
        }
        if ($this->isColumnModified(BookPeer::NUMBER_OF_PAGES)) {
            $modifiedColumns[':p' . $index++]  = 'number_of_pages';
        }
        if ($this->isColumnModified(BookPeer::ISBN_10)) {
            $modifiedColumns[':p' . $index++]  = 'isbn_10';
        }
        if ($this->isColumnModified(BookPeer::ISBN_13)) {
            $modifiedColumns[':p' . $index++]  = 'isbn_13';
        }

        $sql = sprintf(
            'INSERT INTO media_library_media_book (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'number_of_pages':
                        $stmt->bindValue($identifier, $this->number_of_pages, PDO::PARAM_INT);
                        break;
                    case 'isbn_10':
                        $stmt->bindValue($identifier, $this->isbn_10, PDO::PARAM_STR);
                        break;
                    case 'isbn_13':
                        $stmt->bindValue($identifier, $this->isbn_13, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getNumberOfPages(),
            $keys[3] => $this->getIsbn10(),
            $keys[4] => $this->getIsbn13(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setNumberOfPages($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setIsbn10($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setIsbn13($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookPeer::MEDIA_ID)) $criteria->add(BookPeer::MEDIA_ID, $this->media_id);
        if ($this->isColumnModified(BookPeer::NUMBER_OF_PAGES)) $criteria->add(BookPeer::NUMBER_OF_PAGES, $this->number_of_pages);
        if ($this->isColumnModified(BookPeer::ISBN_10)) $criteria->add(BookPeer::ISBN_10, $this->isbn_10);
        if ($this->isColumnModified(BookPeer::ISBN_13)) $criteria->add(BookPeer::ISBN_13, $this->isbn_13);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNumberOfPages($this->getNumberOfPages());
