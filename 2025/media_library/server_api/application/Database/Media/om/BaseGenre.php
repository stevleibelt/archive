...
/**
 * Base class that represents a row from the 'media_library_media_genre' table.
 *
 *
 *
...
abstract class BaseGenre extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Database\\Media\\GenrePeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO media_library_media_genre (%s) VALUES (%s)',
    ...
    public function setMediaToGenres(PropelCollection $mediaToGenres, PropelPDO $con = null)
    {
        ...
        foreach ($mediaToGenresToDelete as $mediaToGenreRemoved) {
            $mediaToGenreRemoved->setGenre(null);
        }
     ...
     * @return PropelObjectCollection|MediaToGenre[] List of MediaToGenre objects
     */
    public function getMediaToGenresJoinMedia($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = MediaToGenreQuery::create(null, $criteria);
