...
/**
 * Base class that represents a row from the 'media_library_media_audio' table.
 *
 *
 *
...
abstract class BaseAudio extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Database\\Media\\AudioPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO media_library_media_audio (%s) VALUES (%s)',
