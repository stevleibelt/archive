...
use Database\Media\map\GameTableMap;

/**
 * Base static class for performing query and update operations on the 'media_library_media_game' table.
 *
 *
 *
...
abstract class BaseGamePeer
{
    ...
    const TABLE_NAME = 'media_library_media_game';

    /** the related Propel class for this table */
    const OM_CLASS = 'Database\\Media\\Game';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\Media\\map\\GameTableMap';
    ...
    const ID = 'media_library_media_game.id';

    /** the column name for the media_id field */
    const MEDIA_ID = 'media_library_media_game.media_id';

    /** the column name for the platform_id field */
    const PLATFORM_ID = 'media_library_media_game.platform_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'MediaId', 'PlatformId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'mediaId', 'platformId', ),
        BasePeer::TYPE_COLNAME => array (GamePeer::ID, GamePeer::MEDIA_ID, GamePeer::PLATFORM_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'MEDIA_ID', 'PLATFORM_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'media_id', 'platform_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MediaId' => 1, 'PlatformId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'mediaId' => 1, 'platformId' => 2, ),
        BasePeer::TYPE_COLNAME => array (GamePeer::ID => 0, GamePeer::MEDIA_ID => 1, GamePeer::PLATFORM_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'MEDIA_ID' => 1, 'PLATFORM_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'media_id' => 1, 'platform_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GamePeer::MEDIA_ID);
            $criteria->addSelectColumn(GamePeer::PLATFORM_ID);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to media_library_media_game
    ...
    public static function doCountJoinMedia(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(GamePeer::MEDIA_ID, MediaPeer::ID, $join_behavior);
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinPlatform(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(GamePeer::PLATFORM_ID, PlatformPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Game objects pre-filled with their Media objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinMedia(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Game) to $obj2 (Media)
                $obj2->addGame($obj1);
    ...
    /**
     * Selects a collection of Game objects pre-filled with their Platform objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Game objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinPlatform(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = PlatformPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = PlatformPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    $obj2 = new $cls();
                    $obj2->hydrate($row, $startcol);
                    PlatformPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Game) to $obj2 (Platform)
                $obj2->addGame($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PlatformPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + PlatformPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Game) to the collection in $obj2 (Media)
                $obj2->addGame($obj1);
            } // if joined row not null

            // Add objects for joined Platform rows

            $key3 = PlatformPeer::getPrimaryKeyHashFromRow($row, $startcol3);
            if ($key3 !== null) {
                $obj3 = PlatformPeer::getInstanceFromPool($key3);
                if (!$obj3) {
                    ...
                    PlatformPeer::addInstanceToPool($obj3, $key3);
                } // if obj3 loaded

                // Add the $obj1 (Game) to the collection in $obj3 (Platform)
                $obj3->addGame($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptPlatform(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of Game objects pre-filled with all related objects except Media.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptMedia(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PlatformPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + PlatformPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = GamePeer::getInstanceFromPool($key1))) {
                ...
                $key2 = PlatformPeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = PlatformPeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (Game) to the collection in $obj2 (Platform)
                $obj2->addGame($obj1);
    ...
    /**
     * Selects a collection of Game objects pre-filled with all related objects except Platform.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptPlatform(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseGamePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\Media\map\GameTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the media_library_media_game table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
