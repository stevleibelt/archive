...
/**
 * Base class that represents a row from the 'media_library_media_game' table.
 *
 *
 *
...
abstract class BaseGame extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Database\\Media\\GamePeer';
    ...
    public function setMediaId($v)
    {
        ...
        if ($this->media_id !== $v) {
            $this->media_id = $v;
            $this->modifiedColumns[] = GamePeer::MEDIA_ID;
        }
    ...
    public function setPlatformId($v)
    {
        ...
        if ($this->platform_id !== $v) {
            $this->platform_id = $v;
            $this->modifiedColumns[] = GamePeer::PLATFORM_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->platform_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GamePeer::MEDIA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'media_id';
        }
        if ($this->isColumnModified(GamePeer::PLATFORM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'platform_id';
        }

        $sql = sprintf(
            'INSERT INTO media_library_media_game (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'media_id':
                        ...
                        break;
                    case 'platform_id':
                        $stmt->bindValue($identifier, $this->platform_id, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aPlatform) {
                $result['Platform'] = $this->aPlatform->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setPlatformId($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GamePeer::MEDIA_ID)) $criteria->add(GamePeer::MEDIA_ID, $this->media_id);
        if ($this->isColumnModified(GamePeer::PLATFORM_ID)) $criteria->add(GamePeer::PLATFORM_ID, $this->platform_id);
     ...
     * @throws PropelException
     */
    public function setPlatform(Platform $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Platform object, it will not be re-added.
        if ($v !== null) {
            $v->addGame($this);
        }
     ...
     * @throws PropelException
     */
    public function getPlatform(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPlatform === null && (($this->platform_id !== "" && $this->platform_id !== null)) && $doQuery) {
            $this->aPlatform = PlatformQuery::create()->findPk($this->platform_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPlatform->addGames($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPlatform instanceof Persistent) {
              $this->aPlatform->clearAllReferences($deep);
            }
