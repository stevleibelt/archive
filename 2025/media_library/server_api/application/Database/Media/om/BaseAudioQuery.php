...
/**
 * Base class that represents a query for the 'media_library_media_audio' table.
 *
 *
 *
...
abstract class BaseAudioQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, media_id, number_of_discs FROM media_library_media_audio WHERE id = :p0';
        try {
