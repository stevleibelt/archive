...
use Database\Media\map\ArtistTableMap;

/**
 * Base static class for performing query and update operations on the 'media_library_media_artists' table.
 *
 *
 *
...
abstract class BaseArtistPeer
{
    ...
    const TABLE_NAME = 'media_library_media_artists';

    /** the related Propel class for this table */
    const OM_CLASS = 'Database\\Media\\Artist';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\Media\\map\\ArtistTableMap';
    ...
    const ID = 'media_library_media_artists.id';

    /** the column name for the name field */
    const NAME = 'media_library_media_artists.name';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Artist objects.
     ...
     * e.g. ArtistPeer::$fieldNames[ArtistPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', ),
        BasePeer::TYPE_COLNAME => array (ArtistPeer::ID, ArtistPeer::NAME, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ArtistPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, ),
        BasePeer::TYPE_COLNAME => array (ArtistPeer::ID => 0, ArtistPeer::NAME => 1, ),
    ...
    {
        $toNames = ArtistPeer::getFieldNames($toType);
        $key = isset(ArtistPeer::$fieldKeys[$fromType][$name]) ? ArtistPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ArtistPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ArtistPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ArtistPeer::$fieldNames[$type];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ArtistPeer::ID);
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ArtistPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ArtistPeer::DATABASE_NAME);
     ...
     *
     * @param Artist $obj A Artist object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ArtistPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ArtistPeer::$instances[$key])) {
                return ArtistPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (ArtistPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        ArtistPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to media_library_media_artists
    ...
    public static function populateObject($row, $startcol = 0)
    {
        ...
        if (null !== ($obj = ArtistPeer::getInstanceFromPool($key))) {
            ...
            $col = $startcol + ArtistPeer::NUM_HYDRATE_COLUMNS;
        } else {
    ...
    {
        return Propel::getDatabaseMap(ArtistPeer::DATABASE_NAME)->getTable(ArtistPeer::TABLE_NAME);
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseArtistPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\Media\map\ArtistTableMap());
      }
    }
    ...
    /**
     * Performs an UPDATE on the database, given a Artist or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ArtistPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(ArtistPeer::ID);
            $value = $criteria->remove(ArtistPeer::ID);
            if ($value) {
                $selectCriteria->add(ArtistPeer::ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the media_library_media_artists table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ArtistPeer::ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ArtistPeer::DATABASE_NAME);
            $criteria->add(ArtistPeer::ID, $pks, Criteria::IN);
