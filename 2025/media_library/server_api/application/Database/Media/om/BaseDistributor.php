...
/**
 * Base class that represents a row from the 'media_library_media_distributor' table.
 *
 *
 *
 ...
 */
abstract class BaseDistributor extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Database\\Media\\DistributorPeer';
     ...
     * @return Distributor The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DistributorPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = DistributorPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = DistributorPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Distributor object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DistributorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DistributorQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DistributorPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DistributorPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(DistributorPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO media_library_media_distributor (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DistributorPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DistributorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Distributor'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Distributor'][$this->getPrimaryKey()] = true;
        $keys = DistributorPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DistributorPeer::ID)) $criteria->add(DistributorPeer::ID, $this->id);
        if ($this->isColumnModified(DistributorPeer::NAME)) $criteria->add(DistributorPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(DistributorPeer::DATABASE_NAME);
        $criteria->add(DistributorPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Distributor (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Distributor Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DistributorPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DistributorPeer();
        }
    ...
    public function setMedias(PropelCollection $medias, PropelPDO $con = null)
    {
        ...
        foreach ($mediasToDelete as $mediaRemoved) {
            $mediaRemoved->setDistributor(null);
        }
     ...
     * Otherwise if this Distributor is new, it will return
     * an empty collection; or if this Distributor has previously
     * been saved, it will retrieve related Medias from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Distributor.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(DistributorPeer::DEFAULT_STRING_FORMAT);
    }
