...
/**
 * Base class that represents a query for the 'media_library_media_language' table.
 *
 *
 *
...
abstract class BaseLanguageQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, name, shortcut FROM media_library_media_language WHERE id = :p0';
        try {
