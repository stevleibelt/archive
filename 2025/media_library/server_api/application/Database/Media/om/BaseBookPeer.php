...
use Database\Media\map\BookTableMap;

/**
 * Base static class for performing query and update operations on the 'media_library_media_book' table.
 *
 *
 *
...
abstract class BaseBookPeer
{
    ...
    const TABLE_NAME = 'media_library_media_book';

    /** the related Propel class for this table */
    const OM_CLASS = 'Database\\Media\\Book';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\Media\\map\\BookTableMap';
    ...
    const ID = 'media_library_media_book.id';

    /** the column name for the media_id field */
    const MEDIA_ID = 'media_library_media_book.media_id';

    /** the column name for the number_of_pages field */
    const NUMBER_OF_PAGES = 'media_library_media_book.number_of_pages';

    /** the column name for the isbn_10 field */
    const ISBN_10 = 'media_library_media_book.isbn_10';

    /** the column name for the isbn_13 field */
    const ISBN_13 = 'media_library_media_book.isbn_13';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'MediaId', 'NumberOfPages', 'Isbn10', 'Isbn13', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'mediaId', 'numberOfPages', 'isbn10', 'isbn13', ),
        BasePeer::TYPE_COLNAME => array (BookPeer::ID, BookPeer::MEDIA_ID, BookPeer::NUMBER_OF_PAGES, BookPeer::ISBN_10, BookPeer::ISBN_13, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'MEDIA_ID', 'NUMBER_OF_PAGES', 'ISBN_10', 'ISBN_13', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'media_id', 'number_of_pages', 'isbn_10', 'isbn_13', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MediaId' => 1, 'NumberOfPages' => 2, 'Isbn10' => 3, 'Isbn13' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'mediaId' => 1, 'numberOfPages' => 2, 'isbn10' => 3, 'isbn13' => 4, ),
        BasePeer::TYPE_COLNAME => array (BookPeer::ID => 0, BookPeer::MEDIA_ID => 1, BookPeer::NUMBER_OF_PAGES => 2, BookPeer::ISBN_10 => 3, BookPeer::ISBN_13 => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'MEDIA_ID' => 1, 'NUMBER_OF_PAGES' => 2, 'ISBN_10' => 3, 'ISBN_13' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'media_id' => 1, 'number_of_pages' => 2, 'isbn_10' => 3, 'isbn_13' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookPeer::MEDIA_ID);
            $criteria->addSelectColumn(BookPeer::NUMBER_OF_PAGES);
            $criteria->addSelectColumn(BookPeer::ISBN_10);
            $criteria->addSelectColumn(BookPeer::ISBN_13);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.media_id');
            $criteria->addSelectColumn($alias . '.number_of_pages');
            $criteria->addSelectColumn($alias . '.isbn_10');
            $criteria->addSelectColumn($alias . '.isbn_13');
        }
    }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to media_library_media_book
    ...
    public static function doCountJoinMedia(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BookPeer::MEDIA_ID, MediaPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Book objects pre-filled with their Media objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinMedia(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Book) to $obj2 (Media)
                $obj2->addBook($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Book) to the collection in $obj2 (Media)
                $obj2->addBook($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBookPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\Media\map\BookTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the media_library_media_book table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
