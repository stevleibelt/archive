...
use Database\Media\map\CommentTableMap;
use Database\User\UserPeer;

/**
 * Base static class for performing query and update operations on the 'media_library_media_comment' table.
 *
 *
 *
...
abstract class BaseCommentPeer
{
    ...
    const TABLE_NAME = 'media_library_media_comment';

    /** the related Propel class for this table */
    const OM_CLASS = 'Database\\Media\\Comment';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\Media\\map\\CommentTableMap';
    ...
    const ID = 'media_library_media_comment.id';

    /** the column name for the media_id field */
    const MEDIA_ID = 'media_library_media_comment.media_id';

    /** the column name for the parent_comment_id field */
    const PARENT_COMMENT_ID = 'media_library_media_comment.parent_comment_id';

    /** the column name for the user_id field */
    const USER_ID = 'media_library_media_comment.user_id';

    /** the column name for the create_date field */
    const CREATE_DATE = 'media_library_media_comment.create_date';

    /** the column name for the comment field */
    const COMMENT = 'media_library_media_comment.comment';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'MediaId', 'ParentCommentId', 'UserId', 'CreateDate', 'Comment', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'mediaId', 'parentCommentId', 'userId', 'createDate', 'comment', ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID, CommentPeer::MEDIA_ID, CommentPeer::PARENT_COMMENT_ID, CommentPeer::USER_ID, CommentPeer::CREATE_DATE, CommentPeer::COMMENT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'MEDIA_ID', 'PARENT_COMMENT_ID', 'USER_ID', 'CREATE_DATE', 'COMMENT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'media_id', 'parent_comment_id', 'user_id', 'create_date', 'comment', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MediaId' => 1, 'ParentCommentId' => 2, 'UserId' => 3, 'CreateDate' => 4, 'Comment' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'mediaId' => 1, 'parentCommentId' => 2, 'userId' => 3, 'createDate' => 4, 'comment' => 5, ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID => 0, CommentPeer::MEDIA_ID => 1, CommentPeer::PARENT_COMMENT_ID => 2, CommentPeer::USER_ID => 3, CommentPeer::CREATE_DATE => 4, CommentPeer::COMMENT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'MEDIA_ID' => 1, 'PARENT_COMMENT_ID' => 2, 'USER_ID' => 3, 'CREATE_DATE' => 4, 'COMMENT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'media_id' => 1, 'parent_comment_id' => 2, 'user_id' => 3, 'create_date' => 4, 'comment' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentPeer::MEDIA_ID);
            $criteria->addSelectColumn(CommentPeer::PARENT_COMMENT_ID);
            $criteria->addSelectColumn(CommentPeer::USER_ID);
            $criteria->addSelectColumn(CommentPeer::CREATE_DATE);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to media_library_media_comment
    ...
    {
        $key = CommentPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = CommentPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
    ...
    public static function doCountJoinMedia(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommentPeer::MEDIA_ID, MediaPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their Media objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinMedia(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to $obj2 (Media)
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Comment objects.
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to $obj2 (User)
                $obj2->addComment($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj2 (Media)
                $obj2->addComment($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj3 (User)
    ...
    /**
     * Selects a collection of Comment objects pre-filled with all related objects except Media.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCommentPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\Media\map\CommentTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(CommentPeer::ID);
            if ($value) {
                $selectCriteria->add(CommentPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CommentPeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the media_library_media_comment table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(CommentPeer::TABLE_NAME, $con, CommentPeer::DATABASE_NAME);
