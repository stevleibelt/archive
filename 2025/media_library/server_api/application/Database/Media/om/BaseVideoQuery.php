...
/**
 * Base class that represents a query for the 'media_library_media_video' table.
 *
 *
 *
...
abstract class BaseVideoQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, media_id, duration, number_of_discs FROM media_library_media_video WHERE id = :p0';
        try {
