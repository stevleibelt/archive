...
/**
 * Base class that represents a query for the 'media_library_media_to_artist' table.
 *
 *
 *
...
abstract class BaseMediaToArtistQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, media_id, artist_id FROM media_library_media_to_artist WHERE id = :p0';
        try {
