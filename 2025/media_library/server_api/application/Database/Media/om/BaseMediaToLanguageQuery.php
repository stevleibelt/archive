...
/**
 * Base class that represents a query for the 'media_library_media_to_language' table.
 *
 *
 *
...
abstract class BaseMediaToLanguageQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Database\\Media\\MediaToLanguage';
        }
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new MediaToLanguageQuery(null, null, $modelAlias);
    ...
    {
        $sql = 'SELECT id, media_id, media_language_id FROM media_library_media_to_language WHERE id = :p0';
        try {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Database\Media\LanguageQuery A secondary query class using the current class as primary query
     */
    public function useLanguageQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinLanguage($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Language', '\Database\Media\LanguageQuery');
    }
