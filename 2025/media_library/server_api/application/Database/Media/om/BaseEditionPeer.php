...
use Database\Media\map\EditionTableMap;

/**
 * Base static class for performing query and update operations on the 'media_library_media_edition' table.
 *
 *
 *
...
abstract class BaseEditionPeer
{
    ...
    const TABLE_NAME = 'media_library_media_edition';

    /** the related Propel class for this table */
    const OM_CLASS = 'Database\\Media\\Edition';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\Media\\map\\EditionTableMap';
    ...
    const ID = 'media_library_media_edition.id';

    /** the column name for the name field */
    const NAME = 'media_library_media_edition.name';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (EditionPeer::ID, EditionPeer::NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (EditionPeer::ID => 0, EditionPeer::NAME => 1, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(EditionPeer::ID);
            $criteria->addSelectColumn(EditionPeer::NAME);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to media_library_media_edition
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseEditionPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\Media\map\EditionTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(EditionPeer::ID);
            $value = $criteria->remove(EditionPeer::ID);
            if ($value) {
                $selectCriteria->add(EditionPeer::ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the media_library_media_edition table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(EditionPeer::ID, (array) $values, Criteria::IN);
            // invalidate the cache for this object(s)
            foreach ((array) $values as $singleval) {
                EditionPeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = EditionPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(EditionPeer::DATABASE_NAME);
        $criteria->add(EditionPeer::ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(EditionPeer::DATABASE_NAME);
            $criteria->add(EditionPeer::ID, $pks, Criteria::IN);
            $objs = EditionPeer::doSelect($criteria, $con);
        }
