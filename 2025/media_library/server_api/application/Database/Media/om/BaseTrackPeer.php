...
/**
 * Base static class for performing query and update operations on the 'media_library_media_audio_track' table.
 *
 *
 *
...
abstract class BaseTrackPeer
{
    ...
    const TABLE_NAME = 'media_library_media_audio_track';
    ...
    const ID = 'media_library_media_audio_track.id';

    /** the column name for the name field */
    const NAME = 'media_library_media_audio_track.name';

    /** the column name for the audio_id field */
    const AUDIO_ID = 'media_library_media_audio_track.audio_id';

    /** the column name for the media_id field */
    const MEDIA_ID = 'media_library_media_audio_track.media_id';

    /** the column name for the number_of_play field */
    const NUMBER_OF_PLAY = 'media_library_media_audio_track.number_of_play';

    /** the column name for the number_of_disc field */
    const NUMBER_OF_DISC = 'media_library_media_audio_track.number_of_disc';

    /** the column name for the duration field */
    const DURATION = 'media_library_media_audio_track.duration';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'AudioId', 'MediaId', 'NumberOfPlay', 'NumberOfDisc', 'Duration', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'audioId', 'mediaId', 'numberOfPlay', 'numberOfDisc', 'duration', ),
        BasePeer::TYPE_COLNAME => array (TrackPeer::ID, TrackPeer::NAME, TrackPeer::AUDIO_ID, TrackPeer::MEDIA_ID, TrackPeer::NUMBER_OF_PLAY, TrackPeer::NUMBER_OF_DISC, TrackPeer::DURATION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'AUDIO_ID', 'MEDIA_ID', 'NUMBER_OF_PLAY', 'NUMBER_OF_DISC', 'DURATION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'audio_id', 'media_id', 'number_of_play', 'number_of_disc', 'duration', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'AudioId' => 2, 'MediaId' => 3, 'NumberOfPlay' => 4, 'NumberOfDisc' => 5, 'Duration' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'audioId' => 2, 'mediaId' => 3, 'numberOfPlay' => 4, 'numberOfDisc' => 5, 'duration' => 6, ),
        BasePeer::TYPE_COLNAME => array (TrackPeer::ID => 0, TrackPeer::NAME => 1, TrackPeer::AUDIO_ID => 2, TrackPeer::MEDIA_ID => 3, TrackPeer::NUMBER_OF_PLAY => 4, TrackPeer::NUMBER_OF_DISC => 5, TrackPeer::DURATION => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'AUDIO_ID' => 2, 'MEDIA_ID' => 3, 'NUMBER_OF_PLAY' => 4, 'NUMBER_OF_DISC' => 5, 'DURATION' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'audio_id' => 2, 'media_id' => 3, 'number_of_play' => 4, 'number_of_disc' => 5, 'duration' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TrackPeer::MEDIA_ID);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to media_library_media_audio_track
    ...
    /**
     * Deletes all rows from the media_library_media_audio_track table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
