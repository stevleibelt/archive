...
/**
 * Base class that represents a row from the 'media_library_media_artists' table.
 *
 *
 *
...
abstract class BaseArtist extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Database\\Media\\ArtistPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO media_library_media_artists (%s) VALUES (%s)',
    ...
    public function setMediaToArtists(PropelCollection $mediaToArtists, PropelPDO $con = null)
    {
        ...
        foreach ($mediaToArtistsToDelete as $mediaToArtistRemoved) {
            $mediaToArtistRemoved->setArtist(null);
        }
     ...
     * @return PropelObjectCollection|MediaToArtist[] List of MediaToArtist objects
     */
    public function getMediaToArtistsJoinMedia($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = MediaToArtistQuery::create(null, $criteria);
