...
/**
 * Base class that represents a row from the 'media_library_media_comment' table.
 *
 *
 *
...
abstract class BaseComment extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Database\\Media\\CommentPeer';
    ...
    public function setMediaId($v)
    {
        ...
        if ($this->media_id !== $v) {
            $this->media_id = $v;
            $this->modifiedColumns[] = CommentPeer::MEDIA_ID;
        }
    ...
    public function setCreateDate($v)
    {
        ...
        if ($this->create_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommentPeer::CREATE_DATE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->parent_comment_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommentPeer::MEDIA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'media_id';
        }
        if ($this->isColumnModified(CommentPeer::PARENT_COMMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'parent_comment_id';
        }
        if ($this->isColumnModified(CommentPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(CommentPeer::CREATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'create_date';
        }
        if ($this->isColumnModified(CommentPeer::COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'comment';
        }

        $sql = sprintf(
            'INSERT INTO media_library_media_comment (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'parent_comment_id':
                        $stmt->bindValue($identifier, $this->parent_comment_id, PDO::PARAM_STR);
                        break;
                    case 'user_id':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentPeer::MEDIA_ID)) $criteria->add(CommentPeer::MEDIA_ID, $this->media_id);
        ...
        if ($this->isColumnModified(CommentPeer::CREATE_DATE)) $criteria->add(CommentPeer::CREATE_DATE, $this->create_date);
