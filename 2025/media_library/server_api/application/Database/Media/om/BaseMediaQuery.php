...
/**
 * Base class that represents a query for the 'media_library_media_common' table.
 *
 *
 *
...
abstract class BaseMediaQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, distributor_id, edition_id, type_id, user_id, age_limit, create_date, release_date, name FROM media_library_media_common WHERE id = :p0';
        try {
