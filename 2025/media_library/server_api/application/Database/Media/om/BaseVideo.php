...
/**
 * Base class that represents a row from the 'media_library_media_video' table.
 *
 *
 *
...
abstract class BaseVideo extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Database\\Media\\VideoPeer';
    ...
    public function setMediaId($v)
    {
        ...
        if ($this->media_id !== $v) {
            $this->media_id = $v;
            $this->modifiedColumns[] = VideoPeer::MEDIA_ID;
        }
    ...
    public function setNumberOfDiscs($v)
    {
        ...
        if ($this->number_of_discs !== $v) {
            ...
            $this->modifiedColumns[] = VideoPeer::NUMBER_OF_DISCS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->number_of_discs = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = VideoPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(VideoPeer::MEDIA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'media_id';
        }
        if ($this->isColumnModified(VideoPeer::DURATION)) {
            $modifiedColumns[':p' . $index++]  = 'duration';
        }
        if ($this->isColumnModified(VideoPeer::NUMBER_OF_DISCS)) {
            $modifiedColumns[':p' . $index++]  = 'number_of_discs';
        }

        $sql = sprintf(
            'INSERT INTO media_library_media_video (%s) VALUES (%s)',
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setNumberOfDiscs($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VideoPeer::MEDIA_ID)) $criteria->add(VideoPeer::MEDIA_ID, $this->media_id);
        if ($this->isColumnModified(VideoPeer::DURATION)) $criteria->add(VideoPeer::DURATION, $this->duration);
        if ($this->isColumnModified(VideoPeer::NUMBER_OF_DISCS)) $criteria->add(VideoPeer::NUMBER_OF_DISCS, $this->number_of_discs);
