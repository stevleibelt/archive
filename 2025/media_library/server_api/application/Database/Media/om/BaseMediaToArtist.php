...
/**
 * Base class that represents a row from the 'media_library_media_to_artist' table.
 *
 *
 *
 ...
 */
abstract class BaseMediaToArtist extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Database\\Media\\MediaToArtistPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        MediaToArtistPeer
     */
     ...
     * @return MediaToArtist The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = MediaToArtistPeer::ID;
        }
    ...
    public function setMediaId($v)
    {
        ...
        if ($this->media_id !== $v) {
            $this->media_id = $v;
            $this->modifiedColumns[] = MediaToArtistPeer::MEDIA_ID;
        }
    ...
    public function setArtistId($v)
    {
        ...
        if ($this->artist_id !== $v) {
            $this->artist_id = $v;
            $this->modifiedColumns[] = MediaToArtistPeer::ARTIST_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->artist_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = MediaToArtistPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating MediaToArtist object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MediaToArtistPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MediaToArtistQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MediaToArtistPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MediaToArtistPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(MediaToArtistPeer::MEDIA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'media_id';
        }
        if ($this->isColumnModified(MediaToArtistPeer::ARTIST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'artist_id';
        }

        $sql = sprintf(
            'INSERT INTO media_library_media_to_artist (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'media_id':
                        ...
                        break;
                    case 'artist_id':
                        $stmt->bindValue($identifier, $this->artist_id, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MediaToArtistPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MediaToArtistPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MediaToArtist'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MediaToArtist'][$this->getPrimaryKey()] = true;
        $keys = MediaToArtistPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MediaToArtistPeer::ID)) $criteria->add(MediaToArtistPeer::ID, $this->id);
        if ($this->isColumnModified(MediaToArtistPeer::MEDIA_ID)) $criteria->add(MediaToArtistPeer::MEDIA_ID, $this->media_id);
        if ($this->isColumnModified(MediaToArtistPeer::ARTIST_ID)) $criteria->add(MediaToArtistPeer::ARTIST_ID, $this->artist_id);
    ...
    {
        $criteria = new Criteria(MediaToArtistPeer::DATABASE_NAME);
        $criteria->add(MediaToArtistPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of MediaToArtist (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return MediaToArtist Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return MediaToArtistPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new MediaToArtistPeer();
        }
    ...
    public function getMedia(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMedia === null && (($this->media_id !== "" && $this->media_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMedia->addMediaToArtists($this);
             */
        }
    ...
    {
        if ($this->aArtist === null && (($this->artist_id !== "" && $this->artist_id !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aArtist->addMediaToArtists($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MediaToArtistPeer::DEFAULT_STRING_FORMAT);
    }
