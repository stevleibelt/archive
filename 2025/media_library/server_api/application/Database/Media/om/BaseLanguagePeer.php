...
use Database\Media\map\LanguageTableMap;

/**
 * Base static class for performing query and update operations on the 'media_library_media_language' table.
 *
 *
 *
...
abstract class BaseLanguagePeer
{
    ...
    const TABLE_NAME = 'media_library_media_language';

    /** the related Propel class for this table */
    const OM_CLASS = 'Database\\Media\\Language';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Database\\Media\\map\\LanguageTableMap';
    ...
    const ID = 'media_library_media_language.id';

    /** the column name for the name field */
    const NAME = 'media_library_media_language.name';

    /** the column name for the shortcut field */
    const SHORTCUT = 'media_library_media_language.shortcut';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Shortcut', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'shortcut', ),
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID, LanguagePeer::NAME, LanguagePeer::SHORTCUT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'SHORTCUT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'shortcut', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Shortcut' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'shortcut' => 2, ),
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID => 0, LanguagePeer::NAME => 1, LanguagePeer::SHORTCUT => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'SHORTCUT' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'shortcut' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn($alias . '.shortcut');
        }
    }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to media_library_media_language
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseLanguagePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Database\Media\map\LanguageTableMap());
      }
    }
    ...
    /**
     * Deletes all rows from the media_library_media_language table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
